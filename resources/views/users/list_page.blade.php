                    ...
                    <form method="GET" action="{{ route('order') }}" class="mb-3">
                        <div class="input-group" style="gap: 5px;">
                            <input type="text" name="search" value="{{ $search ?? '' }}"
                                class="form-control text-center" placeholder="ค้นหา Student ID..."
                                style="border-radius: 20px;">
                            <button type="submit" class="btn btn-primary" style="border-radius: 20px;">ค้นหา</button>
                        </div>
                    </form>
                </div>
                ...
                <div>
                    @if (!empty($search) && $students->isNotEmpty())
                        ...
                        <div class="mb-3 p-3 bg-light rounded shadow-sm">
                            <div class="fw-bold">ชื่อนักเรียน: {{ $student->full_name }}</div>
